...
<html>
    ...
    <body>
        <div class="container mt-5">
            <h5 class="mb-5">จองห้องประชุม Room I</h5>
            <!-- <div>
            <a href="roomI.php" type="button" class="btn btn-primary">ย้อนกลับ</a>
            </div> -->
            <div class="mt-2">
            <form action="insertBookingroomI.php" method="post" onSubmit="JavaScript:return checkSubmit();">
                <div class="mb-3 row">
                    <label for="date" class="col-sm-2 col-form-label">Room</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="room" name="room" value="I" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="num_person" class="col-sm-2 col-form-label">จำนวนผู้ประชุม</label>
                    <div class="col-sm-6">
                        <input type="number" class="form-control" id="num_person" name="num_person" max="6">
                    </div>
                </div>
                <div class="mb-3 row">
