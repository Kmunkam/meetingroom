...
<html>
    ...
    <body>
        ...
        <!-- Modal -->
        <div class="modal fade" id="editroomP" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="updateroomP.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="text_statusroom" class="col-sm-4 col-form-label">หมายเหตุ</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="text_statusroom" name="text_statusroom">
