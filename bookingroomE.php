...
<html>
    ...
    <body>
        <div class="container mt-5">
            <h5 class="mb-5">จองห้องประชุม Room E</h5>
           
            <div class="mt-5">
            <form action="insertBookingroomE.php" method="post" onSubmit="JavaScript:return checkSubmit();">
                <div class="mb-3 row">
                    <label for="date" class="col-sm-2 col-form-label">Room</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="room" name="room" value="E" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mt-5">
                    <a href="roomE.php" type="button" class="btn btn-primary">ย้อนกลับ</a>
